        ...
        <div className="grid grid-cols-5 gap-2">
          {['facebook', 'instagram', 'linkedin', 'twitter', 'youtube', 'tiktok', 'github', 'twitch', 'discord', 'snapchat', 'pinterest'].map(p => {
            ...
            const socialIcons: { [k: string]: { svg: string; color: string } } = {
              ...
              twitter: {
                color: '#ffffff',
                svg: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.746l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>`
              },
              youtube: {
                color: '#FF0000',
            ...
            return url ? (
              ...
              >
                <span
                  style={{ color: icon?.color ?? '#ffffff', width: 22, height: 22, display: 'flex', alignItems: 'center' }}
