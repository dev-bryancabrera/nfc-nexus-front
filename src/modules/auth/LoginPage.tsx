    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative z-10">
      <div className="w-full max-w-sm">
        <div className="text-center mb-10">
          <div className="inline-flex w-16 h-16 rounded-2xl bg-accent/20 border border-accent/30 items-center justify-center text-3xl mb-4">⟁</div>
          <div className="font-syne text-3xl font-extrabold gradient-text">BRTECH NFC</div>
          <div className="text-[10px] font-mono text-[var(--text-dim)] tracking-widest mt-1">SMART CARD PLATFORM</div>
        </div>
